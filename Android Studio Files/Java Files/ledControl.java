...
public class ledControl extends ActionBarActivity {
    ...
    public void pickMyColor(View view){
        HSVColorPickerDialog cpd = new HSVColorPickerDialog( ledControl.this, 0xFF4488CC, new HSVColorPickerDialog.OnColorSelectedListener() {
            @Override
